...
(2, 1002, 'Borrowed', 2001, '2023-01-10'),
(3, 1003, 'Available', NULL, NULL),
(4, 1004, 'Borrowed', 2002, '2023-02-15'),
(5, 1005, 'Available', NULL, NULL),
(6, 1001, 'Borrowed', 2003, '2023-03-20'),
(7, 1002, 'Available', NULL, NULL),
(8, 1003, 'Borrowed', 2004, '2023-04-25'),
(9, 1004, 'Available', NULL, NULL),
(10, 1005, 'Borrowed', 2005, '2023-05-30');

select * from books_entity where status="Available";
select * from books_entity where status="Borrowed";
